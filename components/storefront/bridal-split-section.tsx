  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-1/2 overflow-hidden bg-brand-navy">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-brand-navy/70 to-brand-navy/40" />
      ...
      <div className="absolute right-0 top-0 bottom-0 w-1/2 overflow-hidden bg-brand-navy">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-bl from-brand-navy/60 to-brand-navy/30" />
      ...
      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-center bg-brand-navy/95 border border-brand-gold/20 shadow-[var(--shadow-modal)] backdrop-blur-sm"
      ...
      >
        ...
        {/* Title — h2 inherits Playfair Display + weight 600 from globals */}
