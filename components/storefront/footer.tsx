      ...
      <div className="container-site py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/85 leading-relaxed mb-6 max-w-[200px]">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="text-sm font-semibold text-brand-gold-light mb-4 uppercase tracking-wide">
                {title}
              </h3>
        ...
        {/* Bottom bar */}
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col items-center justify-between gap-4 text-xs text-white/70 sm:flex-row">
