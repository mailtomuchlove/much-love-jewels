          ...
          <section className="section">
            <div className="container-site">
              <div className="flex items-end justify-between mb-8 md:mb-10">
                ...
                <Link
                  href="/collections"
                  className="text-sm font-medium text-brand-navy hover:text-brand-gold transition-colors underline underline-offset-4"
                >
                  View All
                </Link>
              </div>
        ...
        <section className="section bg-brand-navy">
          <div className="container-site">
            <FadeIn className="max-w-2xl mx-auto text-center">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-sm font-medium text-brand-gold hover:text-brand-gold-light transition-colors underline underline-offset-4"
              >
                Learn about us
              </Link>
            </FadeIn>
